...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_CAPS,   KC_Q,    KC_W,    KC_E,   KC_R,   KC_T,   KC_CUT,
        KC_LCTL,   KC_A,    KC_S,    KC_D,   KC_F,   KC_G,   KC_CALC,
        KC_ESC,    KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,
        KC_INS,    KC_LCTL, KC_LEFT, KC_RGHT,KC_LALT,
                                    KC_LSFT, KC_LCTL,
                                    KC_HOME,
                                    KC_DEL, KC_BSPC, KC_END,
        // right hand
                      TG(_NUMPAD), KC_6,    KC_7,    KC_8,     KC_9,     KC_0,     KC_MINS,
                          ...
                          KC_PSTE, KC_H,    KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
                                   KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
                                            KC_APP,  KC_UP,    KC_DOWN,  KC_LBRC,  KC_RBRC,
             KC_RGUI, KC_RSFT,
             KC_PGUP,
